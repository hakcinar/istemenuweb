...
const Page = ({ params: { restaurantNo, tableNo } }) => {
  ...
  return (
    <>
      <div className="text-white flex flex-1 flex-col bg-black px-4">
        <h1 className="text-white text-2xl mt-4 font-medium mb-2">Sepetim</h1>
        {loading ? (
          <div>Yükleniyor...</div>
        ) : (
          <div className="flex flex-1 pb-[134px] flex-col">
            {Array.isArray(basket) && basket.length > 0 ? (
              ...
              <div className="flex justify-start flex-col bg-gray p-4 rounded-xl">
                <h1 className="text-sm text-yellow font-medium mb-2">
        ...
        {Array.isArray(basket) && basket.length > 0 && (
          <div className="bg-black left-0 fixed bottom-[72px] px-4 w-full rounded-xl">
