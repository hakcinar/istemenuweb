...
const NavLink = ({ icon, href, text }) => {
  ...
  const linkClass =
    "flex items-center text-white font-medium flex-col justify-center";
  const activeLinkClass =
    "flex items-center text-yellow font-medium flex-col justify-center";
